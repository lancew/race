...
var $author$project$HomePage$sendData = _Platform_outgoingPort(
	'sendData',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'week',
					$elm$json$Json$Encode$int($.week)),
					_Utils_Tuple2(
					'weeks',
					$elm$json$Json$Encode$int($.weeks)),
					_Utils_Tuple2(
					'yacht1Progress',
					$elm$json$Json$Encode$int($.yacht1Progress)),
					_Utils_Tuple2(
					'yacht2Progress',
					$elm$json$Json$Encode$int($.yacht2Progress)),
					_Utils_Tuple2(
					'yacht3Progress',
					$elm$json$Json$Encode$int($.yacht3Progress))
				]));
	});
...
var $author$project$HomePage$DecrementYacht3 = {$: 'DecrementYacht3'};
var $author$project$HomePage$IncrementWeek = {$: 'IncrementWeek'};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'The Race week: ' + ($elm$core$String$fromInt(model.week) + (' of ' + $elm$core$String$fromInt(model.weeks))))
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HomePage$IncrementWeek)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('+')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HomePage$DecrementWeek)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('-')
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HomePage$IncrementYacht1)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('+')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HomePage$DecrementYacht1)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('-')
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HomePage$IncrementYacht2)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('+')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HomePage$DecrementYacht2)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('-')
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HomePage$IncrementYacht3)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('+')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HomePage$DecrementYacht3)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('-')
